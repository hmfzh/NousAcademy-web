...
<body>
    ...
    <div class="container">
        <div class="container-2">
            ...
            <hr class="bg-dark">
            <form class="container form-horizontal" action="tambah_materi_proses.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="" class="control-label col-sm-2">Judul</label>
                    <div class="col-sm-7">
