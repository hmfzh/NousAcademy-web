	...
	<div class="container-2">
		<div class="content m-5 pl-5 pt-3">
			...
			<div class="container">
				...
				$bab = $_GET['bab'];
				$topik = $_GET['topik'];
				$sql = "SELECT * FROM tugas WHERE kelas = '" . $_SESSION['kelas'] . "' AND bab = '" . $bab . "' AND topik = '" . $topik . "' ";
				$query = mysqli_query($conn, $sql);
				while($result = mysqli_fetch_assoc($query)) {
				?>
				<h3><?php echo $result['topik'] . '<br>'; ?>
					<small class="text-muted"><?php echo $result['deskripsi'] . '<br>'; ?></small>
				</h3>
				<?php } ?>

				<div class="container-3">
					<form action="upload_tugas_proses.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label for="nim" class="control-label col-sm-2">File Terlampir</label>
							<div class="col-sm-7">
