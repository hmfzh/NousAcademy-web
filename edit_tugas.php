...
<body>
    ...
    <div class="container">
        <div class="container-2">
            ...
            <form class="container form-horizontal" action="edit_tugas_proses.php" method="post" role="form">
                <?php
                $sql = "SELECT * FROM tugas WHERE id = '" . $_SESSION['id_tugas'] . "' ";
                ...
                ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="bab" id="" class="form-control" placeholder="Bab" required value="<?php echo $data['bab']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="topik" id="nm" class="form-control" placeholder="topik" required value="<?php echo $data['topik']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control" rows="6" name="deskripsi" id="" required><?php echo $data['deskripsi']; ?>"</textarea>
                        </div>
                    </div>
                    <button class="btn btn-outline-primary" type="submit" name="submit">Edit</button>
                    <a class="btn btn-outline-danger" href="delete_tugas.php?id=<?php echo $data['id']; ?>" role="button">Delete</a>
                <?php } ?>
            </form>
        </div>
    </div>
